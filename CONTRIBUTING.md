...
```
git clone git@github.com:$USER/ux-framework.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `ux-framework` repository on GitHub to your computer.
